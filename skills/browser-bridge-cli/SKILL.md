...
4. Select the repo's `extension/` folder from https://github.com/NmadeleiDev/browser_agent_bridge.
...
- `Auth Token / JWT`: `change-me-strong-token`
7. Click `Save`, then `Connect`.
8. Confirm popup status is connected.
